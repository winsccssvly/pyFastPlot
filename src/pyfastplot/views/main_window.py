...
from PySide6.QtWidgets import (
    ...
    QTableWidgetItem, QScrollArea, QLineEdit, QSplitter
)
...
from .components.table import TableWidget
from .components.plot_canvas import MplCanvas, AspectRatioWidget
...
class MainWindow(QMainWindow):
    ...
    def _create_top_layout(self):
        ...
        # Set initial horizontal sizes so the options panel fills remaining space perfectly
    ...
    def _create_bottom_layout(self):
        ...
        # Adjust horizontal sizes to balance the Data Table, Spreadsheet, and Data Selection.
    ...
    def apply_global_plot_settings(self, settings):
        ...
        self.sc.axes.set_xlabel(settings.get('xlabel', ''), fontsize=settings.get('label_size', 10))
        self.sc.axes.set_ylabel(settings.get('ylabel', ''), fontsize=settings.get('label_size', 10))
        
        self.sc.axes.tick_params(axis='both', which='major', labelsize=settings.get('tick_size', 10))
